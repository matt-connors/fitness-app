...
interface ExerciseItemProps {
    ...
    onUpdateExercise: (id: string, field: string, value: string | number | boolean) => void;
...
const ExerciseItem: React.FC<ExerciseItemProps> = ({
    ...
    const exerciseContent = (
        <ThemedSection style={{
            ...
            <View style={{
                marginVertical: SPACING.pageVerticalInside + 5,
                ...
                <TouchableOpacity
                    style={{ 
                        flexDirection: 'row', 
                        alignItems: 'center',
                        alignSelf: 'flex-start' // Make toggle only as wide as content
                    }}
                ...
                <TouchableOpacity
                    ...
                    onPress={() => onUpdateExercise(item.id, 'showRpe', !item.showRpe)}
                >
                    <View style={{
                        width: 22,
                        height: 22,
                        ...
                        alignItems: 'center',
                        marginRight: 8,
                        borderColor: item.showRpe ? accentColor : borderStrongerColor,
                        backgroundColor: item.showRpe ? accentColor : contrastBackgroundColor,
                    }}>
                        {item.showRpe ?
                            <Check size={14} color={accentTextColor} strokeWidth={2} /> :
                            <X size={14} color={textColor} strokeWidth={2} />
                    ...
                    <ThemedText style={{ fontSize: 14, fontWeight: '400' }}>Use RPE instead of weight</ThemedText>
                </TouchableOpacity>
            </View>
